...
public class OzgurKocaeliScraper implements NewsScraper {
    ...
    private static final Logger log = LoggerFactory.getLogger(OzgurKocaeliScraper.class);
    private static final String BASE_URL = "https://www.ozgurkocaeli.com.tr";
    private static final int DELAY_MS = 400;

    private final ScraperRuntimeConfig scraperLimits;

    public OzgurKocaeliScraper(ScraperRuntimeConfig scraperLimits) {
    ...
    public List<RawNews> scrape(int days) {
        ...
        try {
            ...
            log.error("Özgür Kocaeli scraping sırasında hata oluştu: {}", e.getMessage(), e);
        }
